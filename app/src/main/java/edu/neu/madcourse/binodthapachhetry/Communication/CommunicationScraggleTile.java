...
public class CommunicationScraggleTile {
    ...
    private final CommunicationScraggleGameActivityFragment mGame;
    private Owner mOwner = Owner.NEITHER;
    private View mView;
    private CommunicationScraggleTile mSubTiles[];

    public CommunicationScraggleTile(CommunicationScraggleGameActivityFragment game) {
        this.mGame = game;
    }
    ...
    public CommunicationScraggleTile[] getSubTiles() {
        return mSubTiles;
    }

    public void setSubTiles(CommunicationScraggleTile[] subTiles) {
