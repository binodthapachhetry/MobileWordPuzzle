...
public class TwoPlayerGameRegisterUser extends AppCompatActivity implements View.OnClickListener{

    private static final String TAG = "TwoPlayerGameRegister";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_player_game_register_user);
        remoteClient = new TwoPlayerGameRemoteClient(this);
        gcm = GoogleCloudMessaging.getInstance(this);
        context = getApplicationContext();
        regid = getRegistrationId(context);

        mDisplay = (TextView) findViewById(R.id.two_player_game_display);
        rMessage = (EditText) findViewById(R.id.two_player_game_newusertextBox);

        registerUserButton = (Button) findViewById(R.id.two_player_game_new_user_button_second);
        enterGameButton = (Button) findViewById(R.id.two_player_game_enter_game_button);
    ...
    public void onClick(View view) {
        if (view == findViewById(R.id.two_player_game_new_user_button_second)) {
...
//                    regid = getRegistrationId(context);
                    ...
                    if (TextUtils.isEmpty(regid)) {
                        ...
                        update.put("highScore",HIGH_SCORE);
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        return getSharedPreferences(TwoPlayerGameMain.class.getSimpleName(), Context.MODE_PRIVATE);
    }
