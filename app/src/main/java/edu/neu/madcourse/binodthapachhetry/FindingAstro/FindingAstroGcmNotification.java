...
import edu.neu.madcourse.binodthapachhetry.TwoPlayerGame.TwoPlayerGameConstants;

/**
 * Created by jarvis on 4/22/16.
 */
public class FindingAstroGcmNotification {
...
//                            Toast.LENGTH_SHORT).show();
    ...
    private void post(Map<String, String> params, List<String> regIds)
        ...
        URL url;
        try {
            url = new URL(TwoPlayerGameConstants.BASE_URL);
        } catch (MalformedURLException e) {
            throw new IllegalArgumentException("invalid url: "
                    + TwoPlayerGameConstants.BASE_URL);
        }
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "key="
                    + TwoPlayerGameConstants.GCM_API_KEY);
