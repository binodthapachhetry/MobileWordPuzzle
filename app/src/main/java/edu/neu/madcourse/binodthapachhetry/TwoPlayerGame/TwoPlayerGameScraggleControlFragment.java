...
public class TwoPlayerGameScraggleControlFragment extends Fragment {

    private AlertDialog mDialog;
//    private MediaPlayer mMediaPlayer;
    public Context contextControl;
    public TwoPlayerGameScraggleGameActivityFragment mScraggleGame;
       ...
       scraggleTimer = (TextView) rootView.findViewById(R.id.two_player_game_timer);
        ...
        buttonRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((TwoPlayerGameScraggleGameActivity) getActivity()).restartGame();
                countDownTimerOne = new MyCountDownTimerOne(startTime, interval);
        ...
        buttonQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().finish();
                Intent myIntent = new Intent(getActivity(), TwoPlayerGameScraggleMainActivity.class);
...
//                Intent helpIntent = new Intent(getActivity(), edu.neu.madcourse.binodthapachhetry.MainActivity.class);
    ...
    public void goBack(){
        Intent helpIntent = new Intent(getActivity(), TwoPlayerGameScraggleMainActivity.class);
