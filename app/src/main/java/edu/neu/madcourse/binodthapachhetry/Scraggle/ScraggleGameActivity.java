...
public class ScraggleGameActivity extends Activity implements ScraggleControlFragment.onTimeEndListener, ScraggleGameActivityFragment.wordFoundListener, ScraggleControlFragment.onRestartButtonClickListener{
    ...
    public ScraggleControlFragment mGameControl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGameControl = (ScraggleControlFragment) getFragmentManager().findFragmentById(R.id.scraggle_fragment_control);
